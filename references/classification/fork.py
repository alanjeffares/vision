...
# torchrun --nproc_per_node=1 train.py --model resnet18 --data-path ../../../../imagenet_data/imagenet/
# torchrun --nproc_per_node=1 train.py --model resnet18 --data-path ../../../../imagenet_data/imagenet/ | tee test.txt


class Ensemble(nn.Module):
    def __init__(self, num_learners, num_classes, probs=False, drop_p=0, device='cuda'):
        ...
        for _ in range(self.num_learners):
            learner_network = tv_models.resnet18()
...
def main(args):
    ...
    model = Ensemble(num_learners = 3, num_classes = num_classes).to(device)
